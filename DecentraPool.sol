...
contract DecentraPool is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Decentralised Pool Token", "DPT") {
        coinsBalance[msg.sender] = 10; // fund deployer's wallet with 10 coins
    }

    // A helper function to create a new Token
    ...
    // A function to transfer a token from seller to market up token for sale
    ...
    // buy token and transfer to buyer
    ...
    // return total purchase count of caller
    ...
    // transfer all funds  in contract to caller
